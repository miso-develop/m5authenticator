...
const ja: Record<string, string> = {
  ...
  "Factory Reset completed. Encrypted user state and active registration were removed; stable Device ID was preserved.": "Factory Resetが完了しました。暗号化ユーザー状態と有効なregistrationを削除し、安定Device IDは保持されました。",
