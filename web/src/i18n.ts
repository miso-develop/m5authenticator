...
const ja: Record<string, string> = {
  ...
  "No encrypted Vault": "暗号化Vaultなし",
  "This browser's encrypted Vault state is stored locally in IndexedDB. Plaintext credentials, Passphrases, VMKs, BUKs, and BRK private key material are never exported in a Recovery Package.": "このブラウザの暗号化Vault状態はIndexedDBへローカル保存されます。平文の認証情報、Passphrase、VMK、BUK、BRK秘密鍵materialがRecovery Packageへエクスポートされることはありません。",
  ...
  "Create the encrypted Vault from the Import accounts section after connecting an unprovisioned Device": "未プロビジョニングDeviceへ接続後、「アカウントをインポート」から暗号化Vaultを作成してください",
