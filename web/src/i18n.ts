...
const ja: Record<string, string> = {
  ...
  "Canonical status refreshed.": "Canonical statusを更新しました。",
  ...
  "Canonical Vault update completed.": "Canonical Vaultの更新が完了しました。",
  ...
  "Account renamed in the canonical Vault.": "Canonical Vault内のアカウント名を変更しました。",
  "Deleting account from canonical Vault…": "Canonical Vaultからアカウントを削除しています…",
  "Account deleted from the canonical Vault.": "Canonical Vaultからアカウントを削除しました。",
  "Reordering canonical accounts…": "Canonicalアカウントを並べ替えています…",
  "Canonical account order updated.": "Canonicalアカウントの並び順を更新しました。",
