...
const ja: Record<string, string> = {
  ...
  "Firmware update manifest has an invalid firmware path": "Firmware update manifestに不正なfirmware pathがあります",
  ...
  "Passphrase must contain 15 to 128 Unicode code points after NFC normalization": "PassphraseはNFC正規化後にUnicode 15〜128コードポイントである必要があります",
  "Passphrase exceeds the 512-byte UTF-8 limit after NFC normalization": "PassphraseはNFC正規化後のUTF-8で512バイト以内である必要があります",
  "Recovery Passphrase is obviously weak, repetitive, sequential, or common. Choose a long unique Passphrase.": "Recovery Passphraseが明らかに弱い、反復的、連続的、または一般的です。長く一意なPassphraseを選んでください。",
